...
execute join(['function! vital#_loupe#Config#import() abort', printf("return map({'define': '', 'translate': '', 'config': ''}, \"vital#_loupe#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
